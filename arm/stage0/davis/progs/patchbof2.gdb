# buffer in gdb is at 
# this one is for omitting the switch to thumb since it
# appears we are in thumb mode already. thumb2 maybe?


# fix up the svc 1 to svc 0
set var *(char *)  0x7efff6ba = 0


# fix up the null term byte on "/bin/sh"
set var *(char *) 0x7efff6c7 = 0
