...
; Not using the section commands since I just want raw bytes for the opcodes.


; This will be the ptr[s] location. I'm saving it with a marker
; So I can use gdb to change it manually.
s: db '771509048',0x0 ; This is 10 bytes counting the null
   db 'AAAAAA'		  ; So we have a marker for locating our Function pointer 

ptrs_s_: dd 0xbffff350 	; so our address at 0xbffff340 contains a pointer to a function at
						; at address 0xbffff350. Its part of the model.
		db 'BBBB'		; Another marker before we get to code
		db 'BBBB'
		db 'BBBB'
